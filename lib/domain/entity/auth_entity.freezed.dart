...
mixin _$AuthEntity {
 ...
 int? get id; String? get name; String? get email; String? get password; String? get avatar; String? get authToken;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,email,password,avatar,authToken);

@override
String toString() {
  return 'AuthEntity(id: $id, name: $name, email: $email, password: $password, avatar: $avatar, authToken: $authToken)';
}
...
@useResult
$Res call({
 int? id, String? name, String? email, String? password, String? avatar, String? authToken
});
...
/// Create a copy of AuthEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? name = freezed,Object? email = freezed,Object? password = freezed,Object? avatar = freezed,Object? authToken = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  String? name,  String? email,  String? password,  String? avatar,  String? authToken)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthEntity() when $default != null:
return $default(_that.id,_that.name,_that.email,_that.password,_that.avatar,_that.authToken);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  String? name,  String? email,  String? password,  String? avatar,  String? authToken)  $default,) {final _that = this;
switch (_that) {
case _AuthEntity():
return $default(_that.id,_that.name,_that.email,_that.password,_that.avatar,_that.authToken);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  String? name,  String? email,  String? password,  String? avatar,  String? authToken)?  $default,) {final _that = this;
switch (_that) {
case _AuthEntity() when $default != null:
return $default(_that.id,_that.name,_that.email,_that.password,_that.avatar,_that.authToken);case _:
  return null;
...
class _AuthEntity implements AuthEntity {
  const _AuthEntity({this.id, this.name, this.email, this.password, this.avatar, this.authToken});
...
/// Create a copy of AuthEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? name = freezed,Object? email = freezed,Object? password = freezed,Object? avatar = freezed,Object? authToken = freezed,}) {
